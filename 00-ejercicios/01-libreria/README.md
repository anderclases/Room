...
El sistema está formado por varias operaciones CRUD.

Para probar que el sistema funciona adecuadamente se han realizado pruebas con los siguientes datos.
